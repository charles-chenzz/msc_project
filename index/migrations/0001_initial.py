# Generated by Django 2.2.10 on 2021-10-22 02:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release', models.DateTimeField(blank=True, default=datetime.date(1999, 12, 14), null=True, verbose_name='发行时间')),
                ('img', models.FileField(default='暂无图片', upload_to='songImg/', verbose_name='歌曲图片')),
                ('lyrics', models.FileField(blank=True, default='暂无歌词', upload_to='songLyric/', verbose_name='歌词')),
                ('file', models.FileField(default='暂无文件', upload_to='songFile/', verbose_name='歌曲文件')),
